...
def result():
    ...
    if len(l1) == len(l2) and functools.reduce(lambda x, y : x and y, map(lambda p, q: p == q, l1, l2), True): 
        ...
        print(" \      / ")
        print("  ------  ")
        print("YES!!!! My file output matched Dr. Steinberg's sample output! WOOHOO YOU MADE IT THROUGH THE LAST SMALL PROGRAM!!!")
        ...
        diff(l1, l2)
        os.system('cowsay -f dragon Roar! Roar! You have some errors with your output. Keep moving forward, your willingness and dedication to finishing this assignment is key to success.')
